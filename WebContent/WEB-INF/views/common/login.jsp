...
<main class="section narrow">
	...
	<form method="post" action="<%=request.getContextPath()%>/common/login" class="form-grid validated-form">
	...
	<p>Non hai un account? <a href="<%=request.getContextPath()%>/common/registrazione"><u>Registrati</u></a></p>
</main>
</body>
</html>
