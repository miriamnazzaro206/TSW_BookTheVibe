...
<body><%@ include file="/WEB-INF/views/common/navbar.jsp" %><% AttivitaBean a = (AttivitaBean) request.getAttribute("attivita"); %>
<main class="section narrow"><h1>Recensione per <%=a.getTitolo()%></h1>
<form method="post" action="<%=request.getContextPath()%>/common/recensione" class="form-grid validated-form">
